          ...
          <div className="flex flex-col xl:flex-row gap-4 w-full items-stretch xl:items-center"> 
            <div className="flex flex-col lg:flex-row gap-4 flex-1 min-w-0"> 
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-2 lg:w-auto"> 
                <select 
                  className="border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-lime-400 transition duration-300 focus:border-transparent min-w-0 lg:min-w-[140px]" 
                  value={filterStatus} 
            ...
            <button 
              ...
              className="bg-lime-500 hover:bg-lime-600 text-white px-6 py-2 rounded-lg font-semibold flex items-center justify-center gap-2 transition-colors whitespace-nowrap xl:self-center" 
            > 
